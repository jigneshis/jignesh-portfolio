...
const ProjectCard = ({ project, index }: { project: typeof projects[0], index: number }) => {
  ...
  return (
    <motion.div
      ...
      className="group relative border-t border-white/[0.05] last:border-b interactive-card"
    >
      ...
      <div className="relative py-14 md:py-24 px-6 md:px-12 flex flex-col md:flex-row md:items-center justify-between gap-10 cursor-pointer transition-all duration-700 group-hover:bg-white/[0.01]">
        ...
        <div className="flex items-center gap-16 self-end md:self-center" style={{ transform: "translateZ(30px)" }}>
          ...
          <div className="w-20 h-20 rounded-full border border-white/[0.08] flex items-center justify-center group-hover:bg-primary group-hover:border-primary transition-all duration-700 rotate-[-45deg] group-hover:rotate-0 group-hover:scale-110 shadow-2xl">
            <ArrowUpRight
              size={32}
